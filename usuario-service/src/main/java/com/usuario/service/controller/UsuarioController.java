...
public class UsuarioController {
	...
	private ResponseEntity<List<Carro>> fallBackSaveCarro(@PathVariable(name = "usuarioId")int usuarioId,@RequestBody Carro carro,RuntimeException exception){
	...
	private ResponseEntity<List<Moto>> fallBackSaveMoto(@PathVariable(name = "usuarioId")int usuarioId,@RequestBody Moto moto,RuntimeException exception){
		return new ResponseEntity("El usuario :" + usuarioId + "no tiene dinero para esa moto",HttpStatus.OK);
	}
	
	private ResponseEntity<List<Carro>> fallBackGetTodos(@PathVariable(name = "usuarioId")int usuarioId,RuntimeException exception){
